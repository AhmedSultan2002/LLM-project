...
The repository follows a branching workflow with meaningful commit messages.
Phase~1 deliverables were developed on the
\texttt{refactor/code-quality-and-tests} branch and merged to \texttt{main}
via Pull Request \#1.
